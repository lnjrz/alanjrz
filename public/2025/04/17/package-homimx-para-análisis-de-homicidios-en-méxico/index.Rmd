...
La función contiene cinco parametros, y solo es obligatorio especificar la base de datos __*(homidata)*__. Opcionalmente, el usuario puede especificar __*anio_tipo*__, es decir el año de "ocurrencia" o "registro". También puede selecionar la desagregación por "entidad" o "municipio" mediante el parametro __*desagregacion*__ y especificar la desagregación geográfica como "registro" u "ocurrencia" con el parametro __*geo_tipo*__. Asimismo, si el usuario está interesado en conocer homicidios de edades especificas o rangos de edades, puede usar el parametro __*edad*__.


Si el usuario no especifica los parametros opcionales, la función genera una tabla por año de ocurrencia sin desagregación geográfica o edad, es decir, el total de homicidios que ocurrieron año con año como se muestra en la siguiente tabla:
...
Al usar los parametros, es posible obtener una tabla por año de registro, entidad o municipio de ocurrencia y para personas en un rango de edad específico, en este caso personas entre 12 y 17 años de edad: 
```{r, eval = FALSE}
# Estructura completa
...
La principal diferencia de esta función (y del resto de funciones) con la función __tabla_total()__, es que las columnas de la tabla generada corresponden a las categorías de la función y no al sexo. En este caso, muestra las causas de la defunción listadas en CIE-10 y CIE-9, las cuales fueron reclasificadas mediante equivalencias para obtener homicidios cometidos por: __*disparo de arma de fuego*__, __*agresión con objeto cortante o punzante*__, __*ahorcamiento, extrangulamiento o asfixia*__, __*otros medio*__ y __*medios no especificados*__.

Por ello, la estructura de la función tiene una pequeña variación, incorporando el paramétro __*sexo*__ el cual puede tomar el valor "hombres" o "mujeres" y por defecto muestra el total. De tal forma, la función completa se construye de la siguiente manera:
